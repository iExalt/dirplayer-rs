...
type TVmCallbacks = {
  ...
  onFlashMemberLoaded?: (spriteNum: number, castLib: number, castMember: number, swfData: Uint8Array, width: number, height: number, pausedAtStart: boolean, assertedFrame: number, ownerKey: string, preparedGeneration?: number) => void,
  onFlashMemberResized?: (spriteNum: number, generation: number, width: number, height: number, ownerKey: string) => void,
  onFlashMemberUnloaded?: (spriteNum: number, ownerKey: string) => void,
  onFlashMemberUnloadedAtGeneration?: (spriteNum: number, generation: number, ownerKey: string) => void,
