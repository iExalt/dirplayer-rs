...
impl SoundMemberHandlers {
    pub fn get_prop(
        ...
        match prop.into_builtin() {
            ...
            Some(BuiltInSymbol::Media) => Ok(Datum::media(Media::Sound(sound.clone()))),
            Some(BuiltInSymbol::Duration) => Ok(Datum::Int(sound.info.duration as i32)),
            Some(BuiltInSymbol::SampleRate) => Ok(Datum::Int(sound.info.sample_rate as i32)),
            ...
            Some(BuiltInSymbol::CuePointTimes) => {
