use crate::{
    ...
    player::{
        ...
        handlers::datum_handlers::cast_member_ref::{
            borrow_member_mut_with_player, checked_get_datum,
        },
    ...
    pub fn get_prop(
        ...
        match builtin_symbol(&prop, symbols)? {
            ...
            Some(BuiltInSymbol::FontStyle) => {
                Ok(Datum::String(button.field.font_style.to_string()))
            }
            ...
            Some(BuiltInSymbol::ButtonType) => {
                Ok(Datum::Symbol(Symbol::builtin(button.button_type.symbol())))
            }
            Some(BuiltInSymbol::ForeColor) => match &button.field.fore_color {
            ...
            Some(BuiltInSymbol::Alignment) => borrow_member_mut_with_player(
                ...
                |cast_member, value, symbols| {
                    ...
                    cast_member
                        ...
                        .unwrap()
                        .field
                        .alignment = symbols.intern(&value).into_builtin_or_error(symbols)?;
                    Ok(())
                },
            ),
