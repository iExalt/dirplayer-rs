...
define_builtin_symbols! {
    ...
    "period" => Period,
    // Global Lingo verbs dirplayer implements that the upstream table lacked.
    "netAbort" => NetAbort,
    "preLoadCast" => PreLoadCast,
    "unLoadCast" => UnLoadCast,
    ...
    "setContentsBefore" => SetContentsBefore,
    "setContentsAfter" => SetContentsAfter,
    "split" => Split,
    "fill" => Fill,
    "draw" => Draw,
